...
//ResultSet rs;
int i = st.executeUpdate("insert into bug_report(bug_name, bug_type, bug_level, priority,pname,testercode,bugdate,e_code,status) values ('"+Bug_Name+"','" + Bug_Type + "','" + Bug_Level + "','"+Priority+"','"+ProjectName+"','"+ TesterCode+"','" + Bug_Date + "', '"+Employeecode+"', '" + Status+ "')");
